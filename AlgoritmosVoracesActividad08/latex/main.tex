...
\begin{center}
    ...
    {\large \textbf{Materia:} Analisis y Diseño de Algoritmos\\[0.2cm]
\end{center}
...
\textbf{Enlace al repositorio:} \url{https://github.com/ZapanaDiego/Analisis-y-Disenio-de-Algoritmos/tree/main/AlgoritmosVoracesActividad08} \\
\textbf{Enlace al repositorio:} \url{git@github.com:ZapanaDiego/Analisis-y-Disenio-de-Algoritmos.git} \\
